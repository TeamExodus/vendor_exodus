...
include $(CLEAR_VARS)
LOCAL_SRC_FILES := healthd_board_exodus.cpp
LOCAL_MODULE := libhealthd.exodus
LOCAL_CFLAGS := -Werror
LOCAL_C_INCLUDES := \
...
include $$(CLEAR_VARS)
LOCAL_MODULE := vendor_exodus_charger_$(notdir $(1))
...
include $(CLEAR_VARS)
LOCAL_MODULE := exodus_charger_res_images
LOCAL_MODULE_TAGS := optional
